...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="{{ url('/admin/dashboard') }}" class="h1"><b>Admin</b></a>
    </div>
    <div class="card-body">
      ...
      <form action="{{ url('/admin/login') }}" method="post">
        ...
        <div class="input-group mb-3">
          <input type="email" name="email" class="form-control" placeholder="Email" @if (isset($_COOKIE['email']))
        ...
        <div class="input-group mb-3">
          <input type="password" name="password" class="form-control" placeholder="Password" @if (isset($_COOKIE['password']))
